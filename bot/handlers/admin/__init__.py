...
from . import user_migration
from . import test_b2p
...
admin_router_aggregate.include_router(user_migration.router)
admin_router_aggregate.include_router(test_b2p.router)
